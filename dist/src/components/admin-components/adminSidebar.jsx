...
function AdminSidebar() {
    ...
    return (<div className={(0, utils_1.cn)("flex flex-col md:flex-row bg-background dark:bg-background border border-neutral-200 dark:border-neutral-700", "h-screen")}>
