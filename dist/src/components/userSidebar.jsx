    ...
    const links = [
        {
            label: "Home",
            href: "/user/home",
            icon: (<icons_react_1.IconHome className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0"/>),
        },
        {
            label: "Create",
            href: "/user/create",
            icon: (<icons_react_1.IconPlus className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0"/>),
        },
        {
            label: "Profile",
            href: "/user/profile",
            icon: (<icons_react_1.IconUser className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0"/>),
        },
        {
            label: "My Ward",
            href: "/user/myward",
            icon: (<icons_react_1.IconMoneybag className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0"/>),
        },
    ];
...
const Logo = () => {
    return (<img className="h-12" src="/logo.svg" alt="logo"/>);
};
exports.Logo = Logo;
const LogoIcon = () => {
